				...
				<header id="header">
					...
					<div class="pull-right">
						...
						<div id="logout" class="btn-header transparent pull-right">
							<span> <a href="{{ asset('login.php') }}" title="Sign Out" data-action="userLogout" data-logout-msg="You can improve your security further after logging out by closing this opened browser"><i class="fa fa-sign-out"></i></a> </span>
						</div>
						<!-- end logout button -->
						...
						<ul class="header-dropdown-list hidden-xs">
							<li>
								...
								<ul class="dropdown-menu pull-right">
									...
									<li>
										<a href="javascript:void(0);"><img src="{{ asset('img/blank.gif') }}" class="flag flag-kp" alt="Korea"> 한국어</a>
									</li>						
								</ul>
							</li>
						</ul>
