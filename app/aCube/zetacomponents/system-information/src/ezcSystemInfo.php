<?php namespace ZetaComponents\SystemInformation;
/**
...
class ezcSystemInfo
{
    ...
    private function setSystemInfoReader()
    {
        ...
        {
            $this->systemInfoReader = new Readers\ezcSystemInfoWindowsReader( $uname );
            $this->osType = 'win32';
            $this->osName = 'Windows';
        ...
        {
            $this->systemInfoReader = new Readers\ezcSystemInfoMacReader();
            $this->osType = 'mac';
        ...
        else
        {
            ...
            {
                $this->systemInfoReader = new Readers\ezcSystemInfoLinuxReader();
                $this->osName = 'Linux';
                $this->fileSystemType = 'unix';
                $this->lineSeparator= "\n";
                $this->backupFileName = '~';
            ...
            {
                $this->systemInfoReader = new Readers\ezcSystemInfoFreeBsdReader();
                $this->osName = 'FreeBSD';
                $this->fileSystemType = 'unix';
                $this->lineSeparator= "\n";
                $this->backupFileName = '~';
